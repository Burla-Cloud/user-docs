...
Teams that define infra in their code build much simpler more flexible pipelines that fan different functions in and out across thousands of machines with varying sizes, types, and environments.\
