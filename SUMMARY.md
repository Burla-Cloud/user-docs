...
* [Start Here: Core Patterns](demo-categories/basic-examples.md)
  ...
  * [Process thousands of files](demo-blogs/process-thousands-of-files-quickly.md)
  * [Process one giant file](demo-blogs/process-one-giant-file-quickly.md)
  * [Process database rows](demo-blogs/process-data-in-your-database-quickly.md)
...
* [Large-Scale Data Processing](demo-categories/data-processing-examples.md)
  ...
  * [Map geotagged Flickr photos](demo-blogs/world-photo-index.md)
...
* [Production Data Workflows](demo-categories/production-data-jobs.md)
  ...
  * [Resize an image corpus](demo-blogs/image-dataset-resize.md)
