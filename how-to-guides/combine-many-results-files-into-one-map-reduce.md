...
If you’re new to `/workspace/shared`, start with [Read and Write GCS Files](read-and-write-gcs-files.md). If you’re new to `func_cpu` and `func_ram`, see the [`remote_parallel_map` API reference](../API-Reference.md).
