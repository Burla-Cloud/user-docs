...
This Software as a Service Agreement (“Agreement”) governs access to and use of Burla’s cloud-based software and services (the “Service”) by the customer (“Customer” or “you”). By creating an account, completing checkout, or using the Service, you agree to this Agreement.

#### 1. Service

Burla provides access to its cloud-based software platform for Customer’s internal business use only.

***

#### 2. Fees

Customer agrees to pay all fees presented at checkout or on invoice. Fees are non-refundable unless required by law.
...
* Attempt to bypass security controls or abuse the platform
...
Burla will maintain reasonable administrative, technical, and organizational safeguards designed to protect Customer Data against unauthorized access, disclosure, alteration, or destruction, as described in Burla’s Privacy Policy. Burla may access Customer Data only as necessary to provide the Service or as required by law.
...
Upon termination or expiration of the Service, Customer will have thirty (30) days to export any Customer Data stored in the Service. After that period, Burla will permanently delete Customer’s software instance and all associated Customer Data. Burla may retain limited metadata solely for internal accounting and compliance purposes, including aggregate compute usage, which does not include Customer Data.
