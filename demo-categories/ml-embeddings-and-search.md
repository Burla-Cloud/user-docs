...
<tr><td><strong>Cluster arXiv abstracts</strong></td><td>Shard metadata, embed every abstract, then cluster and search after the corpus is visible.</td><td><a href="../demo-blogs/arxiv-fossils.md">arxiv-fossils.md</a></td><td><a href="../.gitbook/assets/more-examples/arxiv-fossils-card.png">arxiv-fossils-card.png</a></td></tr>
