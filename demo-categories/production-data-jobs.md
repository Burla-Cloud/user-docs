...
<tr><td><strong>Resize 1M images</strong></td><td>Chunk image keys, resize with Pillow, and stream progress as workers write outputs.</td><td><a href="../demo-blogs/image-dataset-resize.md">image-dataset-resize.md</a></td><td><a href="../.gitbook/assets/more-examples/image-dataset-resize-card.png">image-dataset-resize-card.png</a></td></tr>
